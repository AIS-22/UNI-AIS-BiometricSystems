...
def main():
    ...
    for model_trained_types, dataset_name, folder in options:
        ...
        for gan_removal_option in gan_removal_options:
            print("Training model for " + dataset_name + " with " + folder + " folder and " + str(
                model_trained_types[1]) + " with " + gan_removal_option + " gan removal")
            ...
            model = ResnetClassifier(num_epochs=10,
                                     ...
                                     batch_size=16,
                                     folds=5,
                                     model_name=model_name + gan_removal_option,
